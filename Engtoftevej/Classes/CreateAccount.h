...
@interface CreateAccount : UIViewController <UITextFieldDelegate,UIImagePickerControllerDelegate,UITextViewDelegate,RemoteControllerDelegate,CLLocationManagerDelegate,UINavigationControllerDelegate> {
...
-(void)createPerson:(NSString*)regnskab password:(NSString*)password email:(NSString*)email fuldtnavn:(NSString*)fuldtnavn;
